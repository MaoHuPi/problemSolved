# cd C:\Users\jhou5\OneDrive\桌面\pyDir\run-on-tempo\0
# python c:\Users\jhou5\OneDrive\桌面\pyDir\venv\Lib\site-packages\PyInstaller\__main__.py -F -w ../run-on-tempo.py --icon ../system/image/icon.ico
import pygame
import os
